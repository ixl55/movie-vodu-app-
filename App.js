...
import { View, Text, TouchableOpacity, StyleSheet, StatusBar, BackHandler, Linking, Platform, ActivityIndicator } from 'react-native';
...
const styles = StyleSheet.create({
  ...
  loadingOverlay: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, justifyContent: 'center', alignItems: 'center', backgroundColor: '#0f0f23', zIndex: 10 },
  ...
  nav: { flexDirection: 'row', justifyContent: 'space-evenly', backgroundColor: '#1a1a2e', paddingVertical: 8, borderTopWidth: 1, borderTopColor: '#333' },
  navBtn: { padding: 12 },
